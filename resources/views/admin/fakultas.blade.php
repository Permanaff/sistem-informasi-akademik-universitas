...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <div class="card border-0">
    <div class="card-body">
        <button type="button" class="btn btn-md btn-success mb-3" id="showModalBtn">Tambah Fakultas</button>
        <table class="table table-bordered">
            ...
            <tbody>
                @forelse ($fakultas as $fakul)
                    <tr>
                        <td class="text-center">{{ $fakul->id }}</td>
                        <td class="text-center">{{ $fakul->nama_fakultas }}</td>
                        <td>
